...
// Wrapper class for MPU9250
// Expose simplified functionality
class IMU : public MPU9250 {
  protected:
    const float MAGNETIC_INCLINATION = 7; // 7 deg W
  public:
    ...
    bool init();
    void selftest(float &xaccel, float &yaccel, float &zaccel,
